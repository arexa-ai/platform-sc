...
export interface LibArexaPlatformSharedInterface extends utils.Interface {
  functions: {
...
export interface LibArexaPlatformShared extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LibArexaPlatformSharedInterface;
