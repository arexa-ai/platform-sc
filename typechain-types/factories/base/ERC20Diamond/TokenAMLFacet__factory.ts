...
import type {
  TokenAMLFacet,
  TokenAMLFacetInterface,
} from "../../../base/ERC20Diamond/TokenAMLFacet";
...
export class TokenAMLFacet__factory {
  static readonly abi = _abi;
  static createInterface(): TokenAMLFacetInterface {
    return new utils.Interface(_abi) as TokenAMLFacetInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TokenAMLFacet {
    return new Contract(address, _abi, signerOrProvider) as TokenAMLFacet;
  }
}
