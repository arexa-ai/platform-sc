...
export interface ArexaTokenAMLFacetInterface extends utils.Interface {
  functions: {
...
export interface ArexaTokenAMLFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArexaTokenAMLFacetInterface;
