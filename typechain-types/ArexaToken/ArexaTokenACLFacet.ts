...
export interface ArexaTokenACLFacetInterface extends utils.Interface {
  functions: {
...
export interface ArexaTokenACLFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArexaTokenACLFacetInterface;
