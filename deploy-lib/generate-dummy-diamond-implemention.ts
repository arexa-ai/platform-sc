//See details: https://github.com/zdenham/diamond-etherscan/tree/main
...
export const generateDummyContract = (
	facetList: Contract[],
	{ diamondAddress, network, contractName, spdxIdentifier, solidityVersion }: GenerateContractParams,
): string => {
